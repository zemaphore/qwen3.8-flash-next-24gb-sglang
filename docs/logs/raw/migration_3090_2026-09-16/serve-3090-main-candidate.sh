#!/usr/bin/env bash
# Candidate launcher: the main-based port (b02e16a895 + series-main) on the
# promoted 3090 profile. Same flags/env as serve-3090-flags.sh, but:
#   - SGLANG=/root/quant/sglang-main and VENV=/root/quant/venv-sglang-main
#   - separate elastic control, cache dir, log and port (30011)
# Do not install as the default until step 5/6 validation passes.
set -euo pipefail
...
CTL="${CTL:-/root/quant/elastic-main.ctl}"
SRVLOG="${SRVLOG:-/root/quant/logs/server-main-candidate.log}"
