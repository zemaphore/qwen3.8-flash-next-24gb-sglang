...
| [`RAM_PREFIX_CACHE_PLAN_3090.md`](RAM_PREFIX_CACHE_PLAN_3090.md) | Proposed GPU/RAM hybrid prefix cache for agentic reuse: state preservation, restore/eviction, memory budgets and validation | 2026-09-16 |
